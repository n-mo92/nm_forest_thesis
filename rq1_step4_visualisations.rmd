...
# Add prettier name labels 
class1_fnf_combo$fnf_combo_pretty = c("FAO",
                                      "CORINE + LBM-DE",
                                      "CORINE",
                                      "Hansen/IGBP",
                                      "JAXA",
...
```{r con_treemap_class1_alt}

# CREATE ALTERNATE VERSION WHICH FOCUSES ON CONSENSUS RATHER THAN FOREST PRESENCE

# Add labels for alternative display
class1_fnf_combo$fnf_combo_alt = c("Hansen/IGBP, ESA, JAXA, CORINE, CORINE+LBM-DE",
...
# Plot tree map
treemap(class1_fnf_combo,
        index= c("fnf_combo_alt", "fnf_combo_pretty"),
        vSize="forest_area_ha",
        type="index",
        title = "Class 1 Breakdown: Which 5 maps agreee on non-forest (while 1 other indicates forest)?",
        fontsize.title = 11,
...
# Add prettier name labels 
class2_fnf_combo$fnf_combo_pretty = c("CORINE, FAO",
...
```{r con_treemap_class2_alt}

# CREATE ALTERNATE VERSION WHICH FOCUSES ON CONSENSUS RATHER THAN FOREST PRESENCE
# Add labels for alternative display
class2_fnf_combo$fnf_combo_alt = c("Hansen/IGBP, ESA, JAXA, CORINE+LBM-DE",
