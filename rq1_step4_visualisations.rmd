...
class3_tree_plt <- ggplot(class3_tree_data) +
  ...
  geom_fit_text(data = class3_tree_data,
                ...
                place = "bottomright",
                colour = "black",
                size = c(16, 10, 8, 6, 6, 6, 6, 6, 4, 4, 4),
                reflow = TRUE) + 
...
class4_tree_plt <- ggplot(class4_tree_data) +
  ...
  geom_fit_text(data = class4_tree_data,
                aes(xmin = x0, 
                    ...
                    label = fnf_combo_main),
                colour = "black",
                size = c(20, 12, 12, 10, 8, 8, 8, 8, 8, 4),
                reflow = TRUE) + 
  geom_fit_text(data = class4_tree_data,
                aes(xmin = x0, 
                    xmax = xmax, 
...
Now generate a figure with all the treemaps together.
...
# Once happy with the outputs, save them!
# Note this will output whatever plot was run last!
ggsave("outputs/figures/tree_maps_v1.png",
       width=23,
       height=12
       )
...
# Once happy with the outputs, save them!
# Note this will output whatever plot was run last!
ggsave("outputs/figures/tree_maps_v2.png",
       width=23,
       height=12
       )
