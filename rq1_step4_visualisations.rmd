...
I probably don't need both for the final thesis, but just thought I'd make them both to have some options.
...
consensus_all$forest_nonforest = c("Non-Forest", "Non-Forest", "Non-Forest",
                                   "Undetermined", "Forest", "Forest", "Forest")
consensus_all$consensus = c("Full Consensus", "High Consensus", "Low Consensus", 
                            "No Consensus", 
                            "Low Consensus", "High Consensus", "Full Consensus")
...
ggplot(data=consensus_all, aes(x = interaction(consensus, class), 
  ...
  geom_bar(stat="identity",
           colour="black",
           width=0.5) +
  scale_fill_manual(values=c("white", "#5985de", "#9ce6f1", "#f1ab4a",
                             "#eff171", "#8acc62", "#1a9641")) +
  coord_cartesian(xlim = c(0.5, 7.5), ylim = c(0, 3),  expand=FALSE, clip="off") +
