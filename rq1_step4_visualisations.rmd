...
Now generate a figure with all the treemaps together. **NOTE:** This will look messy in the Rmd outputs - check the save output figure in the next step to see what it really looks like.  
