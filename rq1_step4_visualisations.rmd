...
3. A multi-plot figure with 6 tree maps (1 overall, 5 for each class from 1-5) for showing which FNF maps tend to agree with each other and which do not.
...
Resources for tree maps and multi-plot figures:
https://www.data-to-viz.com/graph/treemap.html
https://r-graph-gallery.com/treemap.html
https://wilkelab.org/cowplot/articles/plot_grid.html

First I create the main tree map which simply shows a breakdown of the classes overall (i.e. the size of the boxes in the tree map are according to the amount of area in that class). In the subsequent steps I create tree maps for class 1-5 (I skip class 0 and 6 as in these classes all the forest maps agree on either non-forest or forest, respectively). The final step is to combine all tree maps into a single, multi-plot figure.
...
Now I generate the tree map figure for class 1 (i.e. which FNF maps agree on non-forest)
...
Now I generate the tree map figure for class 2 (i.e. which FNF maps agree on non-forest)
...
Now I generate the tree map figure for class 3 (i.e. which FNF maps agree on forest - in this class there's an even split)
...
Now I generate the tree map figure for class 4 (i.e. which FNF maps agree on forest)
...
Now I generate the tree map figure for class 5 (i.e. which FNF maps agree on forest)
...
Finally, I generate a figure with all the tree maps together. **NOTE:** This will look messy in the Rmd outputs - check the save output figure in the next step to see what it really looks like.  
