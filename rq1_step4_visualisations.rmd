...
ggplot(data=fnf_all, aes(x=factor(fnf_map, fnf_order), y=total_forest_ha/1000000)) +
  ...
  coord_cartesian(ylim=c(3.0, 4.25)) +
  ...
  annotate("text", x=1, y=3.99, 
    ...
    annotate("text", x=0.79, y=3.56, 
           label="-11.29%*", 
           colour="#676767",
           size = 3,
           hjust = 0,
           ) +
      annotate("text", x=1.83, y=3.9, 
           label="-2.02%", 
           colour="#676767",
           size = 3,
           hjust = 0,
           ) +
        annotate("text", x=2.84, y=3.889, 
           label="-2.34%", 
           colour="#676767",
           size = 3,
           hjust = 0,
           ) +
          annotate("text", x=3.81, y=4.14, 
           label="+4.08%", 
           colour="#676767",
           size = 3,
           hjust = 0,
           ) +
            annotate("text", x=4.81, y=4.17, 
           label="+4.75%", 
           colour="#676767",
           size = 3,
           hjust = 0,
           ) +
              annotate("text", x=5.82, y=4.215, 
           label="+5.79%", 
           colour="#676767",
           size = 3,
           hjust = 0,
