...
ggplot(data=consensus_all, aes(x = interaction(consensus, class), 
  ...
  geom_vline(xintercept = 3.5, 
    ...
    geom_vline(xintercept = 4.5, 
      ...
      annotate("text", x=0.762, y=1.25, 
           label="33.82%", 
           colour="black",
           size = 3,
           hjust = 0
           ) +
        annotate("text", x=1.818, y=0.2, 
           label="5.30%", 
           colour="black",
           size = 3,
           hjust = 0
           ) +
          annotate("text", x=2.818, y=0.1, 
           label="2.74%", 
           colour="black",
           size = 3,
           hjust = 0
           ) +
          annotate("text", x=3.813, y=0.18, 
           label="4.65%", 
           colour="black",
           size = 3,
           hjust = 0
           ) +
          annotate("text", x=4.818, y=0.17, 
           label="4.35%", 
           colour="black",
           size = 3,
           hjust = 0
           ) +
          annotate("text", x=5.819, y=0.375, 
           label="9.97%", 
           colour="black",
           size = 3,
           hjust = 0
           ) +
          annotate("text", x=6.762, y=1.465, 
           label="39.17%", 
           colour="white",
           size = 3,
           hjust = 0
