...
:: Translate both tifs to vrts (removed for now - vrts generally seem to cause problems down the line)
::gdal_translate.exe %working_folder%\clc5_class3xx_3035_DE_5m.tif %working_folder%\clc5_class3xx_3035_DE_5m.vrt
::gdal_translate.exe %working_folder%\U2018_CLC2018_V2020_3035_DE_5m.tif %working_folder%\U2018_CLC2018_V2020_3035_DE_5m.vrt